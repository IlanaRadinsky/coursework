...
obs_count <- length(obs_vec) #number of sample sizes we are trying
...
#Reset sample_means
sample_means <- NULL
sample_means = rep(0,total_samps) #rep-> repeat

#total_samps is the number of random samples of sim_power[i,1] observations we want to take
#sample_means is the vector that stores the mean of the sample for each of the total_samps
#samples -> can then look at the distribution of the means and see if they are normally
#distributed. can see how well the average of the sample means predicts the population 
# mean
